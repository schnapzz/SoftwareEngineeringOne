...
Scenario Outline: Employee logs hours succesfully
    ...
    And the activity with title "TestUnfinished" have 0 time registrations
    ...
    And the activity with title "TestUnfinished" have 1 time registrations
...
Scenario Outline: Employee logs makes multiple registrations succesfully
    ...
    Then <totalhours> hours are logged for employee "abcd" for activity "First" for project with id "030901"
    And the activity with title "TestUnfinished" have 2 time registrations
...
Scenario Outline: Employee logs negative hours
	...
	Then the activity with title "TestUnfinished" have 0 time registrations
